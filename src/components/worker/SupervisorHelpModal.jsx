...
export const SupervisorHelpModal = ({ complaint, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-sm overflow-y-auto overscroll-contain">
      <div className="relative w-full max-w-2xl bg-slate-900 border border-rose-800/80 rounded-2xl shadow-2xl overflow-hidden my-auto max-h-[92vh] flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-rose-950 via-slate-900 to-slate-900 p-3.5 sm:p-5 border-b border-rose-900/60 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-rose-500/20 border border-rose-500/40 flex items-center justify-center text-rose-400 animate-pulse shrink-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[11px] sm:text-xs text-rose-300 line-clamp-1 sm:line-clamp-none">
